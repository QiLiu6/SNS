...
config["regression_loss_weight"] = 0.05
...
trainer.load_checkpoint("/scratch/ql2221/CT_models/wandb_data/wandb/run-20260124_220044-2c2x4ojw/files/checkpoint_last.p")
