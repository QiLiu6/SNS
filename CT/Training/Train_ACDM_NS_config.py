...
#Wandb info
config["project"]="CT"
config["wandb_run_name"] = "ACDM_1000"
config["wandb_log_freq"] = 100

#Trainer Info
config["ddp"]=False
config["PDE"]="Kolmogorov"
config["file_path"]="/scratch/ql2221/PDE_data/Kolmogorov_flow/Reynolds10k/ACDM_training_data.p"
...
trainer = Train_CT.ACDM_NS_Trainer(config)
