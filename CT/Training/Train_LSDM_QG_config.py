...
config["wandb_run_name"] = "LSDM_QG"
config["wandb_log_freq"] = 100

#Trainer Info
config["ddp"]=False
config["PDE"]="QG"
config["file_path"]="/scratch/ql2221/PDE_data/2LQG/jet/LSDM_training_data.pt"
...
trainer = Train_CT.LSDM_QG_Trainer(config)
